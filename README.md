...
1. Install Python.
2. Run this command on Windows: "py -m pip install csv collections pathvalidate pathlib". Run this command on Linux/MacOS: "python3 -m pip install csv collections pathvalidate pathlib".
